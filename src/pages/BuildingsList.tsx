    ...
    <div>
      ...
      {buildings === undefined ? (
        ...
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 mb-6">Create your first 3D building model to get started</p>
          <button
            onClick={() => setShowCreateForm(true)}
            className="bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-lg font-semibold transition-colors"
          >
            ...
            >
              <div className="p-6">
                <div className="flex justify-between items-start mb-4">
                  <h3 className="text-lg font-semibold text-gray-900 truncate">{building.name}</h3>
                  <button
                    onClick={(e) => {
                      e.preventDefault();
                      e.stopPropagation();
                ...
                <div className="flex items-center text-gray-600">
                  ...
                  <span className="text-sm">{getTotalFloors(building.sections)} floors</span>
                </div>
              </div>
            </Link>
          ))}
